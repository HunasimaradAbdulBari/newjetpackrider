    ...
    return class JetpackGameScene extends window.Phaser.Scene {
      ...
      preload() {
        ...
        try {
          ...
          console.warn('Video loading failed, using fallback background');
        }
      }
    ...
    return (
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '24px', marginBottom: '20px' }}>Loading Quest Flight...</div>
          <div style={{ fontSize: '16px', opacity: 0.7 }}>Preparing game systems...</div>
        </div>
      </div>
    );
  }
    ...
    <div style={{
      ...
      {isLoading && (
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ marginBottom: '20px' }}>Loading Quest Flight...</div>
            <div style={{ fontSize: '16px', opacity: 0.7 }}>Preparing systems...</div>
          </div>
        </div>
      )}
